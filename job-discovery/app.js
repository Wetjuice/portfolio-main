...
// Export decisions for server-side sync
function exportDecisions() {
    ...
    a.href = url;
    a.download = 'user-decisions.json';
    a.click();
    URL.revokeObjectURL(url);
}

// Auto-export decisions to console for manual sync
window.exportJobDecisions = exportDecisions;
